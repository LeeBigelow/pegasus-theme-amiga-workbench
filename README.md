...
* Features:
  * All Games, Favorites, and Last Played collections
  * A filter for game lists. Use TAB and SHIFT-TAB to move focus to/from filter.
  * Scrollable game descriptions. Use TAB or Details Key to focus description.
